...
{
    /**
     * Display a listing of course bulk discounts for authenticated school.
     */
    ...
    public function show(CourseBulkDiscount $courseBulkDiscount): JsonResponse
    {
        try {
            ...
            // Check authorization
            if ($courseBulkDiscount->owner_id !== $schoolInfo->school_id || $courseBulkDiscount->owner_type !== 'school') {
                return response()->json([
                    'status' => false,
