    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <p>
                ...
                <strong>Your class has been successfully approved by the {{$mailData['schoolName']}}</strong>.
            </p>

            <p>
                You can now start managing your class sessions and begin teaching on  <strong>{{ env('WEBSITE_NAME') }}</strong>.
            </p>
