...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>Thank you for registering with {{ config('app.name') }}! Please activate your account by clicking the button below:</p>
            <p>
                <a href="{{ $mailData['activationLink'] }}" class="button">Activate Your Account</a>
            </p>
