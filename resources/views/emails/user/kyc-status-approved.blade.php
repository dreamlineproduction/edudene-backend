...
<head>
    ...
    <title>KYC verification has been approved</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>We are pleased to inform you that your <strong>Your {{$mailData['kycType']}} KYC verification has been successfully approved</strong>.</p>
