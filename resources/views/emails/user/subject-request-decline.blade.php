...
<div class="container">
    ...
    <div class="content">
        ...
        <p>
            This email is to inform you that your request to add a new subject on 
            <strong>{{ env('WEBSITE_NAME') }}</strong> has been reviewed by our administration team.
        </p>

        <div class="warning-box">
            <p><strong>Request Status:</strong> Declined</p>
            <p>
                {{ $mailData['reason'] ?? 'Your subject request does not meet our platform guidelines or requirements at this time.' }}
            </p>
        </div>

        <p>
            You may review the feedback provided above and submit a new request after making the necessary changes.
            Please ensure that the subject details follow our platform guidelines.
        </p>
