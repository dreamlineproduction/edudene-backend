...
Route::prefix('v1')->group(function () {
    ...
    Route::get('front/courses/{SLUG}/lessons', [FrontCourseController::class, 'freeLesson']);
    ...
    Route::get('front/tutors/{TEACHER_SLUG}/categories', [TutorController::class, 'getCategories']);
    Route::get('front/tutors/{TEACHER_SLUG}/one-on-one-slots', [TutorController::class, 'oneOnOneSlot']);
